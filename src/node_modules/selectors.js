...
export const getHouses = (state, ownProps) => {
   ...
   R.includes(state.housesPage.search.product, house.product)
    ...
    const sortSearchPrice =  state.housesPage.search.increase === 'false' ? R.prop('price'): (R.compose(a => -a, R.prop('price')))
        // R.includes(state.housesPage.search.increase, house.product)
        // const diff = function(a, b) { return a - b; };
        // state.housesPage.search.increase === 'false' && R.prop('price') //=> [2, 4, 5, 7]
