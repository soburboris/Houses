import {
    ...
    FETCH_SEARCH_HOUSE_START,
    FETCH_SEARCH_HOUSE_SUCCESS,
    FETCH_SEARCH_HOUSE_FAILURE,
...
export const searchHouse = text => async dispatch => {
    dispatch({type: FETCH_SEARCH_HOUSE_START})

    try {
       
        dispatch({
            type:FETCH_SEARCH_HOUSE_SUCCESS,
            payload:text
        })
    } catch (err) {
        dispatch({
            type: FETCH_SEARCH_HOUSE_FAILURE,
            error:true
        })
    }
}
// export const searchHouse = text => dispatch => {
//     dispatch({
//         type: SEARCH_HOUSE,
//         payload:text 
//     })
