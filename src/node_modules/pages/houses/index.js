...
class Houses extends Component {
  ...
  render() {
    ...
    const url = match.url
     ...
     const arr = houses.filter ((el => 
       el.id>= offset && el.id < currentPage*limit 
     ))
    ...
    return (
      <Layout>
          ...
          <Pagination total={houses.length} limit={limit} url={url} currentPage={currentPage} className='d-flex flex-row'/>
